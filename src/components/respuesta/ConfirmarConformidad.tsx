// src/components/respuesta/ConfirmarConformidad.tsx
'use client';

import { useState } from 'react';
import { CheckCircle, AlertCircle, Shield, MessageSquare } from 'lucide-react';
...
interface ConfirmarConformidadProps {
    ...
    onConformidadConfirmada: (resultado: { respuesta: RespuestaTramite ; tramiteActualizado: any }) => void; // Cambio aquí
}
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                    ...
                    <li className="flex items-start gap-2">
                        ...
                        <span>
                            <strong>Si NO estás conforme:</strong> Debes crear una observación detallada usando el botón "Hacer Observación" para que el documento sea corregido.
                        </span>
                    </li>
                </ul>
            </div>
                ...
                <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    <span className="flex-1 text-sm text-gray-900">
                        ...
                        <span className="text-gray-600">
                            Al marcar esta casilla y confirmar, acepto que la información presentada es correcta según mi conocimiento.
                        </span>
                    </span>
                </label>
            </div>
