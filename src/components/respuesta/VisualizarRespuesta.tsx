  ...
  return (
    <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6'>
      ...
      <div className='flex items-center gap-3 mb-6'>
        ...
        <div>
          <h3 className='text-lg font-semibold text-gray-900'>Tramite confirmado</h3>
      ...
      <div className='flex items-center gap-2 text-sm text-gray-600 mb-4'>
        ...
        <span>{formatFecha(respuesta.fecha_respuesta)}</span>
      </div>

      {/* Detalles técnicos (metadata legal) */}
      {mostrarDetallesTecnicos && (
        <div className='border-t border-gray-200 pt-4 mt-4'>
          <p className='text-xs font-medium text-gray-700 mb-3'>Información técnica y legal:</p>
            ...
            {respuesta.ip_address && (
              <div className='flex items-center gap-2'>
                ...
                <div>
                  ...
                  <p className='text-xs font-mono text-gray-700'>{respuesta.ip_address}</p>
                </div>
              </div>
            )}
            {respuesta.navegador && (
              <div className='flex items-center gap-2'>
                ...
                <div>
                  ...
                  <p className='text-xs font-medium text-gray-700'>{respuesta.navegador}</p>
                </div>
              </div>
            )}
            {respuesta.dispositivo && (
              <div className='flex items-center gap-2'>
                ...
                <div>
                  ...
                  <p className='text-xs font-medium text-gray-700'>{respuesta.dispositivo}</p>
                </div>
              </div>
            )}
          </div>
