// src/components/respuesta/EstadisticasRespuestas.tsx
'use client';
            ...
            {estadisticas.total === 0 && (
                <div className="bg-gray-50 rounded-lg p-8 text-center">
                    ...
                    <p className="text-xs text-gray-500">
                        Las estadísticas aparecerán cuando los trabajadores respondan a
                        los documentos
                    </p>
                </div>
            )}
