              ...
              <div className='flex items-start gap-4'>
                ...
                <div
                  className={`flex-shrink-0 w-12 h-12 rounded-lg flex items-center justify-center ${
                    isLatest ? 'bg-blue-500 text-white' : 'bg-gray-100 text-gray-600'
                  }`}
                >
                  {isLatest ? <CheckCircle className='w-6 h-6' /> : <Clock className='w-6 h-6' />}
                </div>
                ...
                <div className='flex-1 min-w-0'>
                  <div className='flex items-center justify-between mb-2'>
                    ...
                    <span className='text-xs text-gray-500'>{version.codigo}</span>
                  </div>
                    ...
                    <div className='mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg'>
                      <div className='flex items-start gap-2'>
                        ...
                        <div className='flex-1'>
                          ...
                          <p className='text-xs text-yellow-800'>{version.motivo_reenvio}</p>
                        </div>
                      </div>
                    </div>
                  )}
