          ...
          <div className='flex-1 space-y-3'>
            <div>
              ...
              {documentType.descripcion && (
                <p className='text-sm text-blue-800 mb-3 italic'>{documentType.descripcion}</p>
              )}
            </div>
            ...
            <div className='space-y-2'>
              {documentType.requiere_firma && (
                <div className='flex items-start gap-2'>
                  ...
                  <div>
                    <p className='text-sm font-medium text-gray-900'>Firma Electrónica</p>
                    <p className='text-xs text-gray-700 mt-0.5'>
                      El trabajador deberá aceptar los términos y firmar electrónicamente este
                      documento.
                    </p>
                  </div>
                </div>
              ...
              {documentType.requiere_respuesta && (
                <div className='flex items-start gap-2'>
                  ...
                  <div>
                    <p className='text-sm font-medium text-gray-900'>Respuesta de Conformidad</p>
                    <p className='text-xs text-gray-700 mt-0.5'>
