    ...
    const handleNotificationClick = async (notification: Notification) => {
        try {
            ...
            if (onNotificationClick) {
                ...
                // Navegar al trámite
                if (currentRole === 'RESP') {
                    router.push(`/responsable/tramites/${notification.id_tramite}`);
                } else if (currentRole === 'TRAB') {
                    router.push(`/trabajador/tramites/${notification.id_tramite}`);
                }
            }
        } catch (error) {
                        ...
                        {filteredNotifications.map((notification) => (
                            <button
                                ...
                                className={`w-full text-left p-4 rounded-lg border transition-all hover:shadow-md ${
                                    getNotificationBgColor(notification.tipo, notification.visto)
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center gap-3 mt-2 text-xs text-gray-500">
                                            ...
                                            <span>
                                                {NOTIFICATION_LABELS[notification.tipo as keyof typeof NOTIFICATION_LABELS] ||
                                                    notification.tipo}
                                            </span>
                                        </div>
                                    </div>
