      ...
      <div className='flex min-h-full items-center justify-center p-4'>
        <div className='relative bg-white rounded-xl shadow-xl max-w-2xl w-full'>
            ...
            {paso === 'terminos' ? (
              <>
                    ...
                    <Card className='p-4 bg-gray-50 max-h-60 overflow-y-auto'>
                      <div className='space-y-3 text-sm text-gray-700'>
                        <div>
                          ...
                          <p>
                            Al marcar la casilla de aceptación y solicitar el código de
                            verificación, usted acepta que:
                          </p>
                        ...
                        <div>
                          ...
                          <p>
                            Se enviará un código de verificación de 6 dígitos a su correo
                            electrónico registrado. Este código expira en 5 minutos y es de un solo
                            uso.
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p>
                            Conforme a la Ley N° 27269 - Ley de Firmas y Certificados Digitales y su
                            Reglamento, la firma electrónica es la manifestación de voluntad cierta
                            de una persona en medios electrónicos y tiene la misma validez y
                        ...
                        <div>
                          <h4 className='font-semibold text-gray-900 mb-1'>5. No Repudio</h4>
                          <p>
                ...
                <div className='flex items-start gap-3 p-4 bg-gray-50 border border-gray-200 rounded-lg'>
                  ...
                  />
                  <label htmlFor='acepta-terminos' className='text-sm text-gray-700 cursor-pointer'>
                  ...
                  <div className='bg-blue-50 border border-blue-200 rounded-lg p-3'>
                    <div className='flex items-center justify-between'>
                      <div className='flex items-center gap-2'>
                        ...
                        <span className='text-sm text-blue-900'>Tiempo restante:</span>
                      </div>
                      <span
                        className={`text-lg font-mono font-bold ${
                          tiempoRestante === 'Código expirado' ? 'text-red-600' : 'text-blue-600'
                        }`}
                      >
                        {tiempoRestante}
                      </span>
          ...
          <div className='flex items-center justify-between gap-3 p-6 border-t border-gray-200 bg-gray-50'>
            {paso === 'verificacion' && (
              <Button variant='ghost' onClick={() => setPaso('terminos')} disabled={isSubmitting}>
                Volver
              </Button>
            )}
            <div className='flex-1' />
