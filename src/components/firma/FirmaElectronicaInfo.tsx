        ...
        <div className='flex items-center justify-between gap-3'>
          ...
          >
            ...
            <div className='flex-1 min-w-0'>
              <CardTitle className='text-green-900'>Documento Firmado Electrónicamente</CardTitle>
          ...
          <div className='flex items-center gap-2 flex-shrink-0'>
            ...
            <ExportarFirmaButton firma={firma} procedure={procedure} variant='outline' size='sm' />
          ...
          <div className='space-y-6'>
                ...
                {firma.navegador && (
                  <div className='flex items-start gap-3'>
                    ...
                    <div className='flex-1'>
                      ...
                      <p className='text-sm font-medium text-gray-900'>{firma.navegador}</p>
                    </div>
                  </div>
                )}
                ...
                {firma.dispositivo && (
                  <div className='flex items-start gap-3'>
                    ...
                    <div className='flex-1'>
                      ...
                      <p className='text-sm font-medium text-gray-900'>{firma.dispositivo}</p>
                    </div>
                  </div>
                )}
            ...
            <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
              <p className='text-xs text-blue-800'>
                <span className='font-semibold'>Validez Legal:</span> Esta firma electrónica tiene
                plena validez jurídica conforme a la Ley N° 27269 - Ley de Firmas y Certificados
                Digitales y su Reglamento. El registro de firma constituye prueba fehaciente de la
                manifestación de voluntad del firmante.
              </p>
            </div>
          </div>
        </CardContent>
