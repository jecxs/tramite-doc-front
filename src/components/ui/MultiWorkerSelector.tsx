...
const MultiWorkerSelector: React.FC<MultiWorkerSelectorProps> = ({
    ...
    const handleSelectArea = (areaWorkers: User[]) => {
        ...
        const allSelected = areaWorkerIds.every((id) =>
    ...
    const totalResults = Object.values(filteredWorkers).reduce(
                                                    ...
                                                    {areaWorkers.map((worker) => {
                                                        ...
                                                        return (
                                                            <button
                                                                ...
                                                                type="button"
                                                                onClick={() =>
                                                                    handleToggleWorker(worker.id_usuario)
                                                                }
                                                                className={`
