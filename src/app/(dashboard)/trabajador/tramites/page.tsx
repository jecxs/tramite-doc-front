...
export default function TrabajadorTramitesPage() {
    ...
    const getPriorityInfo = (tramite: any) => {
        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-gray-600 mt-1">
                    Documentos recibidos de las diferentes áreas
                </p>
            </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-blue-700 mt-1">
                            Revisa los documentos que te han enviado
                        </p>
                    </div>
                </div>
            )}
                    ...
                    {tramitesFiltrados.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-600">
                                Aún no has recibido ningún documento
                            </p>
                        </div>
                    ) : (
                                        ...
                                        <div className="flex items-start justify-between gap-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-2 mb-2">
                                                    ...
                                                    {priorityInfo && (
                                                        <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium gap-1 ${priorityInfo.color}`}>
                                                            {priorityInfo.icon}
                                                            {priorityInfo.label}
                                                        </span>
                                                    )}
