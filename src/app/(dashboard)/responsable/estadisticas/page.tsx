...
export default function EstadisticasPage() {
    ...
    const datosEstados = porPeriodo?.distribucion_estados.map(item => ({
        name: item.estado,
        value: item.cantidad,
    })) || [];

    const datosTipos = tiposDocumentos?.distribucion.map(item => ({
        nombre: item.nombre,
        valor: item.total,
    })) || [];
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">
                        Panel de control y análisis de trámites
                    </p>
                </div>
