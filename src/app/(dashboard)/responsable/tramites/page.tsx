    ...
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-gray-600 mt-1'>Documentos enviados a trabajadores</p>
        </div>
      ...
      {showSuccessMessage && (
        <div className='bg-green-50 border border-green-200 rounded-lg p-4 flex items-start gap-3'>
          ...
          <div className='flex-1'>
            <p className='text-sm font-medium text-green-800'>Documento enviado exitosamente</p>
                    ...
                    {tramites.map((tramite) => (
                      ...
                      >
                        <td className='py-4 px-4'>
                          <div className='flex items-center gap-2'>
                            <div className='text-blue-600'>{getEstadoIcon(tramite.estado)}</div>
                        ...
                        <td className='py-4 px-4'>
                          <div className='flex items-center gap-2'>
                            ...
                            <div>
                              ...
                              <p className='text-xs text-gray-500'>{tramite.receptor.correo}</p>
                            </div>
                          </div>
                        </td>
                        <td className='py-4 px-4'>
