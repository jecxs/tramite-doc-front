        ...
        <Card>
          <CardContent className='pt-6'>
            <div className='text-center py-12'>
              ...
              <h3 className='text-lg font-medium text-gray-900 mb-2'>Error al cargar el trámite</h3>
    ...
    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        <div className='flex items-center gap-4'>
          ...
          <div>
            <h1 className='text-2xl font-bold text-gray-900'>Detalles del Trámite</h1>
      ...
      {procedure.requiere_firma && !procedure.firma && procedure.estado === 'LEIDO' && (
        <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-4'>
          <div className='flex items-start gap-3'>
            ...
            <div>
              <p className='text-sm font-medium text-yellow-900'>Esperando firma electrónica</p>
              <p className='text-sm text-yellow-800 mt-1'>
                Este documento requiere la firma del trabajador. El trámite se completará cuando el
                trabajador firme el documento.
              </p>
            </div>
          </div>
        </div>
          ...
          <Card>
            <CardHeader>
              <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-2'>
                  {/* Botón para exportar */}
                  <ExportarHistorialButton procedure={procedure} variant='outline' size='sm' />

                  {/* Botón refrescar existente */}
                  <Button variant='ghost' size='sm' onClick={fetchProcedure} disabled={isLoading}>
            ...
            <CardContent>
              {!procedure.historial || procedure.historial.length === 0 ? (
                ...
                <div className='space-y-4'>
                  {procedure.historial.map((item, index: number) => (
                    <div key={item.id_historial} className='relative'>
                      ...
                      <div className='flex gap-4'>
                        <div
                          className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${getAccionColor(item.accion)}`}
                        >
                        ...
                        <div className='flex-1 pb-4'>
                          <div className='flex items-start justify-between mb-1'>
                            <p className='text-sm font-medium text-gray-900'>
                              {item.accion.charAt(0) +
                                item.accion.slice(1).toLowerCase().replace('_', ' ')}
                            </p>
          ...
          {procedure.requiere_respuesta && (
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6'>
              <div className='flex items-center justify-between mb-4'>
                <h3 className='text-lg font-semibold text-gray-900'>Respuesta del Trabajador</h3>
                {procedure.respuesta ? (
        ...
        <div className='space-y-6'>
            ...
            <Card>
              ...
              <CardContent>
                <div className='space-y-2'>
                  ...
                  {procedure.reenvios.map((reenvio) => (
                    <Link
          ...
          {procedure.requiere_respuesta && (
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-4'>
              <h4 className='text-sm font-semibold text-gray-900 mb-3'>Progreso del Documento</h4>
              <div className='space-y-3'>
                <div className='flex items-center gap-3'>
                  <div
                ...
                <div className='flex items-center gap-3'>
                  ...
                  <div className='flex-1'>
                    ...
                    {procedure.respuesta && (
                      <p className='text-xs text-gray-500'>
                        {new Date(procedure.respuesta.fecha_respuesta).toLocaleDateString()}
                      </p>
                    )}
                  </div>
                </div>
