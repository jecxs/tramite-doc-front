...
import { getPendingObservations, getObservationsStats } from '@/lib/api/observaciones';
...
const CHART_COLORS = ['#267992', '#122547', '#10b981', '#f59e0b', '#ef4444', '#3b82f6'];
...
export default function ResponsableDashboard() {
    ...
    const cardVariants: Variants = { // <-- Agrega el tipado : Variants
        hidden: { opacity: 0, y: 20 },
        visible: (custom: any) => ({ // <-- Cambia (i: number) a (custom: any)
            opacity: 1,
            y: 0,
            transition: {
                // Ahora usa 'custom' en lugar de 'i'
                delay: custom * 0.1,
                duration: 0.5,
                ease: 'easeOut',
            },
                            ...
                            <Card className="relative overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 group">
                                ...
                                <CardContent className="pt-6 relative">
                                    <div className="flex items-start justify-between">
                                        ...
                                        <div className={`p-3 ${stat.bgColor} rounded-xl ${stat.iconColor} transform group-hover:scale-110 transition-transform duration-300`}>
                                            {stat.icon}
                                        </div>
                                    </div>
                                </CardContent>
