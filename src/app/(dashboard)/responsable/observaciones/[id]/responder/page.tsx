// src/app/(dashboard)/responsable/observaciones/[id]/responder/page.tsx
'use client'
...
import { Observation, DocumentType } from '@/types';
...
export default function ResponderObservacionPage() {
    ...
    const fetchObservacion = async () => {
        try {
            ...
            toast.error('Error al cargar la observación');
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600">
                        Trámite: {observacion.tramite?.codigo}
                    </p>
                </div>
            </div>
                    ...
                    <div className="flex-1">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <p className="font-medium">
                                    {observacion.tramite?.documento?.titulo} (v{observacion.tramite?.documento?.version})
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="flex justify-end gap-4">
                ...
                <button
                    ...
                    disabled={isSubmitting || !respuestaText.trim() || (incluyeReenvio && !documentoCorregidoId)}
