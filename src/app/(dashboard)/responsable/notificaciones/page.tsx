    ...
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-gray-600 mt-1'>Centro de notificaciones y alertas</p>
        </div>
      ...
      <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-3'>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>{isConnected ? 'Activo' : 'Desconectado'}</div>
            <p className='text-xs text-muted-foreground'>WebSocket en tiempo real</p>
          </CardContent>
        </Card>
      </div>
